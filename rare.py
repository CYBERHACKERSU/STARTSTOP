...
TOKEN = '7540781553:AAElPZX5s3z4dvkoGpRz0sV51zLhK-xp9Bo'
...
def start(message):
    ...
    if user_id not in AUTHORIZED_USERS:
        bot.send_message(message.chat.id, "🚫 Access Denied! Contact the owner for assistance: @RARExxOWNER")
    else:
        welcome_message = (
            ...
            "📞 Contact the owner on Instagram and Telegram: @RARExxOWNER\n"
...
def owner(message):
    ...
    bot.send_message(message.chat.id, "📞 Contact the owner: @RARExxOWNER")
...
This bot is owned and operated by @RARExxOWNER on Telegram and all4outgaming on Instagram, 🇮🇳. By using this bot, you acknowledge that you understand and agree to the following terms:
...
* **🚫 LIMITATION OF LIABILITY**: The owner and operator of this bot, @RARExxOWNER NOT ANY AGREEMENT MADE BY BY ONLY RARE on Telegram and all4outgaming on Instagram, shall not be liable for any damages or losses arising from the use of this bot, including but not limited to direct, indirect, incidental, punitive, and consequential damages, including loss of profits, data, or business interruption.
...
* **🤝 INDEMNIFICATION**: You agree to indemnify and hold harmless @RARExxOWNER on Telegram and @RARExxOWNER, and its affiliates, officers, agents, and employees, from and against any and all claims, damages, obligations, losses, liabilities, costs or debt, and expenses (including but not limited to attorney's fees) arising from or related to your use of this bot.
* **🌐 THIRD-PARTY LINKS**: This bot may contain links to third-party websites or services, and you acknowledge that @RARExxOWNER on Telegram and all4outgaming on Instagram is not responsible for the content, accuracy, or opinions expressed on such websites or services.
* **🔄 MODIFICATION AND DISCONTINUATION**: You agree that @RARExxOWNER on Telegram may modify or discontinue this bot at any time, without notice, and that you will not be entitled to any compensation or reimbursement for any losses or damages arising from such modification or discontinuation.
...
* **📝 ENTIRE AGREEMENT**: This disclaimer constitutes the entire agreement between you and @RARExxOWNER NOT ANY AGREEMENT MADE BY BY ONLY RARE on Telegram and all4outgaming on Instagram regarding your use of this bot, and supersedes all prior or contemporaneous agreements or understandings.
...
if __name__ == "__main__":
    ...
    print(" 👍 Bot is now online with @RARExxOWNER Script and ready to Ddos_attack! ▰▱▰▱▰▱▰▱▰▱▰▱▰▱")
